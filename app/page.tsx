      ...
      <section className="relative px-8 py-10 max-w-7xl mx-auto">
        ...
        <div className="relative z-10">
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-start mb-14">
           ...
           <div className="grid lg:grid-cols-[5fr_5fr] gap-4 items-start max-w-5xl ml-0">
            <div className="bg-zinc-950/90 border border-zinc-800 rounded-[2.2rem] p-2.5 -mt-305">
